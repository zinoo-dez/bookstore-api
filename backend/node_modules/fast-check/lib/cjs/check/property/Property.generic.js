...
class Property {
    constructor(arb, predicate) {
        ...
        const { beforeEach = Property.dummyHook, afterEach = Property.dummyHook, asyncBeforeEach, asyncAfterEach, } = (0, GlobalParameters_js_1.readConfigureGlobal)() || {};
        if (asyncBeforeEach !== undefined) {
            throw (0, globals_js_1.Error)('"asyncBeforeEach" can\'t be set when running synchronous properties');
        }
        if (asyncAfterEach !== undefined) {
            throw (0, globals_js_1.Error)('"asyncAfterEach" can\'t be set when running synchronous properties');
        }
