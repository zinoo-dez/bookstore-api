...
const ReadRegex_js_1 = require("./ReadRegex.js");
...
function pushTokens(tokens, regexSource, unicodeMode, groups) {
    ...
    for (let index = 0, block = (0, ReadRegex_js_1.readFrom)(regexSource, index, unicodeMode, ReadRegex_js_1.TokenizerBlockMode.Full); index !== regexSource.length; index += block.length, block = (0, ReadRegex_js_1.readFrom)(regexSource, index, unicodeMode, ReadRegex_js_1.TokenizerBlockMode.Full)) {
        ...
        switch (firstInBlock) {
            ...
            case '[': {
                ...
                for (let subIndex = 0, subBlock = (0, ReadRegex_js_1.readFrom)(blockContent, subIndex, unicodeMode, ReadRegex_js_1.TokenizerBlockMode.Character); subIndex !== blockContent.length; subIndex += subBlock.length,
                    subBlock = (0, ReadRegex_js_1.readFrom)(blockContent, subIndex, unicodeMode, ReadRegex_js_1.TokenizerBlockMode.Character)) {
...
function tokenizeRegex(regex) {
    const unicodeMode = (0, globals_js_1.safeIndexOf)([...regex.flags], 'u') !== -1;
