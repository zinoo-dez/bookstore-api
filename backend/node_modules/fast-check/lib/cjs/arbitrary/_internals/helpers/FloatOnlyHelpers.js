...
const FloatHelpers_js_1 = require("./FloatHelpers.js");
const FloatingOnlyHelpers_js_1 = require("./FloatingOnlyHelpers.js");
const safeNegativeInfinity = Number.NEGATIVE_INFINITY;
const safePositiveInfinity = Number.POSITIVE_INFINITY;
const safeMaxValue = FloatHelpers_js_1.MAX_VALUE_32;
...
function refineConstraintsForFloatOnly(constraints) {
    return (0, FloatingOnlyHelpers_js_1.refineConstraintsForFloatingOnly)(constraints, safeMaxValue, exports.maxNonIntegerValue, exports.onlyIntegersAfterThisValue);
}
