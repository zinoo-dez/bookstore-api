...
class FrequencyArbitrary extends Arbitrary_js_1.Arbitrary {
    static from(warbs, constraints, label) {
        ...
        const sanitizedConstraints = {
            depthBias: (0, MaxLengthFromMinLength_js_1.depthBiasFromSizeForArbitrary)(constraints.depthSize, constraints.maxDepth !== undefined),
            maxDepth: constraints.maxDepth != undefined ? constraints.maxDepth : safePositiveInfinity,
            withCrossShrink: !!constraints.withCrossShrink,
        };
        return new FrequencyArbitrary(warbs, sanitizedConstraints, (0, DepthContext_js_1.getDepthContextFor)(constraints.depthIdentifier));
    }
    constructor(warbs, constraints, context) {
        ...
        for (let idx = 0; idx !== warbs.length; ++idx) {
            ...
            (0, globals_js_1.safePush)(this.cumulatedWeights, currentWeight);
        }
    ...
    shrink(value, context) {
        if (context !== undefined) {
            ...
            if (safeContext.clonedMrngForFallbackFirst !== null) {
                ...
                return Stream_js_1.Stream.of(valueFromFirst).join(originalShrinks);
            }
    ...
    defaultShrinkForFirst(selectedIndex) {
        ...
        const rawShrinkValue = new Value_js_1.Value(this.warbs[0].fallbackValue.default, undefined);
        return Stream_js_1.Stream.of(this.mapIntoValue(0, rawShrinkValue, null, undefined));
    }
    ...
    mapIntoValue(idx, value, clonedMrngForFallbackFirst, biasFactor) {
        ...
        return new Value_js_1.Value(value.value, context);
    }
