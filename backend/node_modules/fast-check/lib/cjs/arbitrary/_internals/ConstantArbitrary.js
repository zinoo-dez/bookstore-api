...
class FastConstantValuesLookup {
    constructor(values) {
        this.values = values;
        this.fastValues = new globals_js_1.Set(this.values);
        let hasMinusZero = false;
        let hasPlusZero = false;
        if ((0, globals_js_1.safeHas)(this.fastValues, 0)) {
    ...
    has(value) {
        ...
        return (0, globals_js_1.safeHas)(this.fastValues, value);
    }
}
class ConstantArbitrary extends Arbitrary_js_1.Arbitrary {
    constructor(values) {
        super();
        this.values = values;
    }
    generate(mrng, _biasFactor) {
        ...
        const value = this.values[idx];
        if (!(0, symbols_js_1.hasCloneMethod)(value)) {
            return new Value_js_1.Value(value, idx);
        }
        return new Value_js_1.Value(value, idx, () => value[symbols_js_1.cloneMethod]());
    }
    ...
    shrink(value, context) {
        ...
        return Stream_js_1.Stream.of(new Value_js_1.Value(this.values[0], 0));
    }
}
