...
class SlicedBasedGenerator {
        ...
        if (targetLength !== 0 && this.mrng.nextInt(1, this.biasFactor) === 1) {
            ...
            for (let index = 0; index !== this.slices.length; ++index) {
                ...
                if (slice.length === targetLength) {
                    (0, globals_js_1.safePush)(eligibleIndices, index);
                }
            }
    ...
    next() {
        if (this.nextIndexInSlice <= this.lastIndexInSlice) {
            return new Value_js_1.Value(this.slices[this.activeSliceIndex][this.nextIndexInSlice++], undefined);
        }
        ...
        if (this.mrng.nextInt(1, this.biasFactor) !== 1) {
            ...
            return new Value_js_1.Value(slice[0], undefined);
        }
        ...
        return new Value_js_1.Value(slice[this.nextIndexInSlice++], undefined);
    }
}
