...
function buildStableArbitraryGeneratorCache(isEqual) {
    const previousCallsPerBuilder = new globals_js_1.Map();
    return function stableArbitraryGeneratorCache(builder, args) {
        const entriesForBuilder = (0, globals_js_1.safeMapGet)(previousCallsPerBuilder, builder);
        if (entriesForBuilder === undefined) {
            const newValue = builder(...args);
            (0, globals_js_1.safeMapSet)(previousCallsPerBuilder, builder, [{ args, value: newValue }]);
            return newValue;
        }
        ...
        const newValue = builder(...args);
        (0, globals_js_1.safePush)(safeEntriesForBuilder, { args, value: newValue });
        return newValue;
    };
}
