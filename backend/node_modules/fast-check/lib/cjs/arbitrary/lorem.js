...
const WordsToLorem_js_1 = require("./_internals/mappers/WordsToLorem.js");
const h = (v, w) => {
    return { arbitrary: (0, constant_js_1.constant)(v), weight: w };
};
function loremWord() {
...
/**@__NO_SIDE_EFFECTS__*/function lorem(constraints = {}) {
    ...
    if (mode === 'sentences') {
        const sentence = (0, array_js_1.array)(wordArbitrary, { minLength: 1, size: 'small' }).map(WordsToLorem_js_1.wordsToSentenceMapper, (0, WordsToLorem_js_1.wordsToSentenceUnmapperFor)(wordArbitrary));
        return (0, array_js_1.array)(sentence, { minLength: 1, maxLength: maxCount, size }).map(WordsToLorem_js_1.sentencesToParagraphMapper, WordsToLorem_js_1.sentencesToParagraphUnmapper);
    }
    else {
        return (0, array_js_1.array)(wordArbitrary, { minLength: 1, maxLength: maxCount, size }).map(WordsToLorem_js_1.wordsToJoinedStringMapper, (0, WordsToLorem_js_1.wordsToJoinedStringUnmapperFor)(wordArbitrary));
    }
}
