...
export declare function safeFlat<T, D extends number = 1>(instance: T[], depth?: D): FlatArray<T[], D>[];
...
export declare function safeMapHas<T, U>(instance: Map<T, U>, key: T): boolean;
